...
int main(int argc, char* argv[])
{
  ...
  (HPimg.RescaledCopy()).Save("../resources/lenaRGBHPinfourier.jpg");
  (HPimg2.RescaledCopy()).Save("../resources/lenaRGBHPinspace.jpg");
